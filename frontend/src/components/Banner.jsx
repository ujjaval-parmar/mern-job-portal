            ...
            <form>
                <div className='flex justify-start md:flex-row flex-col'>
                    ...
                    <div className='flex md:rounded-md rounded shadow-sm ring-1 ring-inset  focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
                        <input type="text" name='title' id='title' className='block flex-1 border-0 bg-transparent py-1.5 pl-8 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6' placeholder='What position are you looking for ?' 
